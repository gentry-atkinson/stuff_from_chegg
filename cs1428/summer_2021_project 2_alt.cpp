...
int main()
{
    ...
    do
    {
        ...
        if(ch=='d'||ch=='D')
        {
            ...
            out<<"###############"<<s_n<<"###############\n\n";
            out<<"Designed by:\t\t"<<setw(10)<<d_n<<endl;
            out<<"Ship mass:\t\t"<<setw(9)<<s_m<<" kg"<<endl;
            out<<"Acceleration:\t\t"<<setw(3)<<acc<<" m/s^2\n";
            out<<"Delta V:\t\t"<<setw(10)<<d_v<<" m/s"<<endl;
            out<<"Max Altitude:\t\t"<<setw(5)<<m_a<<" km\n\n";
            out<<"File saves at:\t\t"<<setw(10)<<time(NULL)<<endl;
            out.close();
        }
        else if(ch=='T'||ch=='t')
        {
